  ...
  return (
    <table style={{ borderSpacing: "7px 0px" }}>
      <tbody>
        ...
        <tr>
          <td>
            <a href="#">bestcomments</a>
          </td>
          <td>Highest-voted recent comments</td>
        </tr>
        <tr>
          <td>
            <a href="#">noobstories</a>
          </td>
          <td>Submissions from new accounts</td>
        </tr>
        <tr>
          <td>
            <a href="#">noobcomments</a>
          </td>
          <td>Comments from new accounts</td>
        </tr>
        <tr>
          <td>
            <a href="#">whoishiring</a>
          </td>
          <td>Monthly "Who Is Hiring" threads</td>
        </tr>
        <tr>
          <td>
            <a href="#">proberts</a>
          </td>
          <td>Immigration AMAs with Peter Roberts</td>
        </tr>
      </tbody>
    </table>
  );
